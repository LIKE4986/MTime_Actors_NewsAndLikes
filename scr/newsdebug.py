# list_error = []
# with open("./document/news_done.txt", "r") as file:
#     for line in file:
...
# print(len(set_error))
#
# with open("./document/news_done_.txt", "w") as file:
...
doneurls = []
with open("./document/news_done_.txt", "r") as donefile:
    for line in donefile:
        doneurls.append(line.strip('\n'))
print(len(doneurls), doneurls)

errorurls = []
with open("./document/news_error_.txt", "r") as errorfile:
...
# with open("./document/news_notcrawl.txt","a+") as file:
